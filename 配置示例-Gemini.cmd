...
REM 路由前缀必须是 google: 或 gemini:（见 pepole/providers/registry.py）
set PEPOLE_MODEL_PRIMARY=google:gemini-2.0-flash
set PEPOLE_MODEL_FAST=google:gemini-2.0-flash
