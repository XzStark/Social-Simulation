...
from pepole.config import IssuerArchetype, RegionalGroundingSpec, Scenario
from pepole.providers.base import LLMClient
from pepole.web_search_context import fetch_web_grounding_snippets
...
def _wiki_zh_extract(region: str, *, max_chars: int) -> str:
    ...
    try:
        with httpx.Client(timeout=12.0, follow_redirects=True) as client:
            r = client.get(url, headers={"User-Agent": "pepole-regional-grounding/1.0 (simulation)"})
